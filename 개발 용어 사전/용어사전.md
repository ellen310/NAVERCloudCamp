...
<br/>
예를 들어, Spring framework는 Spring Core를 기반으로 여러 lib를 제공해서 Java Bean들을 실행&관리하는데<br/>
...
<br/>
그치만 이렇게 하면 반복작업도 너무 많고..(Copy&paste. JDBC에서 Connection, Statement, ResultSet등 과정은 거의 반복되니까)<br/>
손가락 아프니까 Framework가 이런 작업들을 묶어서 Utility개념으로 제공해주면, 갖다 쓰면 된다!<br/>
<br/><br/>

...
<form name="addPurchase" method="post" action="/purchase/addPurchase?prod_no=${product.prodNo}">
...
<input type="hidden" name="prodNo" value="10021" />
...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td> 
		<td class="ct_write01">${user.userId}</td>              <%--= EL안썼다면 ((User)session.getAttribute("user")).getUserId() --%>
	...
	<tr>
		<td width="104" class="ct_write">결제방법</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
	...
	<tr>
		<td width="104" class="ct_write">수령자이름</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
	...
	<tr>
		<td width="104" class="ct_write">수령자연락처</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
	...
	<tr>
		<td width="104" class="ct_write">수령자주소</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
	...
	<tr>
		<td width="104" class="ct_write">쿠폰정보</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">

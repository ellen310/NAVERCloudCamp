	...
	<tr>
		...
		<td class="ct_write01">
			<select 	name="paymentOption" 	class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20">
				<option value="${purchase.paymentOption}" selected="${purchase.paymentOption eq '1'}? 'selected' : '' " >현금구매</option>
				<option value="${purchase.paymentOption}" selected="${purchase.paymentOption eq '2'}? 'selected' : '' " >카드구매</option>

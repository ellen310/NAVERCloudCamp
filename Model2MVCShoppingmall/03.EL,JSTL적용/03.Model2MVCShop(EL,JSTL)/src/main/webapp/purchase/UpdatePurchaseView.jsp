...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<td class="ct_write01">
			<select 	name="paymentOption" 	class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20">
				<option value="${purchaseVO.paymentOption}" selected="${purchaseVO.paymentOption eq '1'}? 'selected' : '' " >현금구매</option>
				<option value="${purchaseVO.paymentOption}" selected="${purchaseVO.paymentOption eq '2'}? 'selected' : '' " >현금구매</option>
	...
	<tr>
		<td width="104" class="ct_write">수령자 연락처</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
	...
	<tr>
		<td width="104" class="ct_write">수령자 주소</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
